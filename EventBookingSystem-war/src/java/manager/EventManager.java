...
public class EventManager {
    ...
    public Long addNewEvent(HttpServletRequest request) throws
            VenueConflictException {
        String eventName = request.getParameter("eventName");
        Timestamp startDateTime
                = Timestamp.valueOf(request.getParameter("startDateTime"));
        ...
        Long systemUserId
                = (Long) request.getSession().getAttribute("systemUserId");
        return eventSessionLocal.addNewEvent(eventName, startDateTime,
                endDateTime, venueId, systemUserId);
    }
}
